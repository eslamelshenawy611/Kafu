...
const serviceDetailsData = {
  en: {
    ...
    subtitle:
      "We turn your digital presence into measurable success through creative strategies and results.",
  ...
  ar: {
    ...
    subtitle:
      "نحول تواجدك الرقمي إلى نجاح قابل للقياس من خلال استراتيجيات إبداعية ونتائج ملموسة.",
