...
const serviceDetailsData = {
  en: {
    title: "Influencer Strategy & Engagement",
    subtitle:
      "In today’s digital world, influencers are one of the most powerful ways to connect with your audience authentically. We help you build meaningful collaborations with key beauty, wellness, and lifestyle influencers and KOLs who align with your brand’s philosophy and values.",
    ctaButton: "Request a free quotation",
    services: [
      {
        title: "Influencer Identification",
        description:
          "Finding the right personalities who truly reflect your brand and resonate with your target audience.",
        icon: "/influencer/identification.png",
      },
      {
        title: "Tailored Strategy",
        description:
          "Crafting a campaign roadmap that increases visibility, sparks engagement, and drives conversions.",
        icon: "/influencer/strategyy.png",
      },
      {
        title: "Collaborative Content Creation",
        description:
          "Co-developing inspiring stories through photos, videos, and creative campaigns.",
        icon: "/influencer/content.png",
      },
      {
        title: "Influencer Relationship Management",
        description:
          "Handling outreach, negotiations, contracts, and smooth campaign execution.",
        icon: "/influencer/relationship.png",
      },
      {
        title: "Analytics & Reporting",
        description:
          "Measuring reach, engagement, and conversion to ensure maximum ROI.",
        icon: "/influencer/analytics.png",
      },
    ],
  },
  ar: {
    title: "استراتيجية وتفاعل المؤثرين",
    subtitle:
      "في عالم اليوم الرقمي، المؤثرون يمثلون واحدة من أقوى الطرق للتواصل مع جمهورك بصدق. نحن نساعدك في بناء تعاونات ذات مغزى مع أبرز مؤثري الجمال، والصحة، ونمط الحياة الذين يتماشون مع فلسفة وقيم علامتك التجارية.",
    ctaButton: "اطلب عرض سعر مجاني ",
    services: [
      {
        title: "تحديد المؤثرين",
        description:
          "إيجاد الشخصيات المناسبة التي تعكس علامتك التجارية وتلقى صدى لدى جمهورك المستهدف.",
        icon: "/influencer/identification.png",
      },
      {
        title: "استراتيجية مخصصة",
        description:
          "تصميم خارطة طريق للحملة تزيد من الظهور، وتثير التفاعل، وتحقق التحويلات.",
        icon: "/influencer/strategyy.png",
      },
      {
        title: "إنشاء محتوى تعاوني",
        description:
          "تطوير قصص ملهمة من خلال الصور، والفيديوهات، والحملات الإبداعية.",
        icon: "/influencer/content.png",
      },
      {
        title: "إدارة علاقات المؤثرين",
        description:
          "التواصل، التفاوض، إعداد العقود، وضمان تنفيذ سلس للحملة.",
        icon: "/influencer/relationship.png",
      },
      {
        title: "التحليلات والتقارير",
        description:
          "قياس الوصول، والتفاعل، والتحويل لضمان تحقيق أعلى عائد على الاستثمار.",
        icon: "/influencer/analytics.png",
      },
    ],
  },
...
// Hero slider images
const sliderImages = [
  "/influencer/arrange.png",
  "/influencer/family.png",
  "/influencer/infulance.png",
  "/influencer/planing.png",
  "/influencer/strategy.png",
  "/influencer/team.png",
...
export default function DigitalMarketingService() {
  ...
  const servicePositions = [
    ...
    { angle: 100, radius: getRadius() - 80 }, // top left
  ];
      ...
      >
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p
              className={`text-lg md:text-[19px] text-[#c4c4c4] max-w-2xl mx-auto  ${
          ...
          <div className="relative w-full h-[600px] md:h-[700px] flex items-center justify-center py-10 mt-52">
            ...
            >
              ...
              >
                <img
                  src="/service-image/72db65bc-bf7f-496b-94be-b4dd72a70b68.jpg"
